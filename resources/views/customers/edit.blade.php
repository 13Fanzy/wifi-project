...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-amber-500 to-orange-500">
            <h2 class="text-lg font-semibold text-white">Edit Data Pelanggan</h2>
            <p class="text-amber-100 text-sm">{{ $customer->nama }}</p>
        </div>
        ...
        <form action="{{ route('customers.update', $customer) }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nomor_wa" id="nomor_wa" value="{{ old('nomor_wa', $customer->nomor_wa) }}"
            ...
            <div>
                ...
                <textarea name="alamat" id="alamat" rows="3"
                    ...
                    placeholder="Alamat lengkap pelanggan">{{ old('alamat', $customer->alamat) }}</textarea>
                @error('alamat')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="paket_harga" id="paket_harga" value="{{ old('paket_harga', $customer->paket_harga) }}" required min="0" step="1000"
            ...
            <div>
                ...
                <input type="date" name="tanggal_bergabung" id="tanggal_bergabung" value="{{ old('tanggal_bergabung', $customer->tanggal_bergabung->format('Y-m-d')) }}" required
            ...
            <div class="flex items-center">
                <input type="checkbox" name="status_aktif" id="status_aktif" value="1" {{ old('status_aktif', $customer->status_aktif) ? 'checked' : '' }}
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                <button type="button" onclick="document.getElementById('delete-form').submit(); return confirm('Apakah Anda yakin ingin menghapus pelanggan ini? Semua data pembayaran juga akan dihapus.');"
